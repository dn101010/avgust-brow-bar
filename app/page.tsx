...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Август — Студия бровей и ресниц в Хамовниках, Москва",
    description: "Оформление бровей, ламинирование и наращивание ресниц. Фрунзенская наб. 30с5, 5 мин от м. Фрунзенская. Запись онлайн.",
    url: "https://avgustbrows.ru",
  },
  alternates: { canonical: "https://avgustbrows.ru" },
};
